...
* Также, наверное, в будущем при значительном увеличении количества баннеров (а также фич, тегов, контента), необходимо ограничить их получение каким-то количеством, например 200 шт, а также смещения информации относительно нуля (с помощью команд LIMIT 200 OFFSET N в sql запросе) 
